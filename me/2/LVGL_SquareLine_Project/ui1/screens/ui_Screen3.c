...
void ui_Screen3_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Button1, &ui_img_exit_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_Button3, &ui_img_w_c_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_Keyboard1, 115);
    lv_obj_set_height(ui_Keyboard1, 67);
